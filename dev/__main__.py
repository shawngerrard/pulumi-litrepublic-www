# # sudo kubectl edit sts -- to edit pod sts
# # sudo kubectl edit deployment -- to edit pod deployment
# """
...
from pulumi_kubernetes.helm.v3 import Chart, Release, ReleaseArgs, RepositoryOptsArgs, LocalChartOpts

# Deploy Nginx Ingress Controller Helm chart
# nginx = Chart(
#     "nginx-dev",
#     LocalChartOpts(
#         path="/home/asterion/Documents/temp/helm-charts/charts/nginx-ingress-controller",
#     ),
# )

# Deploy Wordpress/MariaDB Helm chart
wordpress = Chart(
    "wp-dev",
    LocalChartOpts(
        path="/home/asterion/Documents/temp/helm-charts/charts/wordpress",
    ),
)
...
#srv = Service.get("wpdev-wordpress", pulumi.Output.concat(wordpress.status.namespace, "/", wordpress.status.name, "-wordpress"))
...
#cmd = pulumi.Output.concat("kubectl port-forward svc/", srv.metadata.name, " 8080:80")
